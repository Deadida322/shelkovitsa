...
sleep 3
# Проверяем доступность папки _nuxt через Frontend сервис
if curl -s -I https://shelkovitsa.ru/_nuxt/ | grep -q "200 OK\|301\|302"; then
    echo "✅ Статические файлы доступны через Frontend сервис"
else
