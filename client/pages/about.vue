<template>
    <div class="about-page">
        ...
        <div class="d-flex justify-center mt-4 mb-4">
            <vs-button @click="navigateTo('catalog')" type="flat">Перейти в каталог</vs-button>
        </div>
    </div>
</template>
